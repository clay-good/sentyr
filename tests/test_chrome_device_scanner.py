...
from sentyr.core.scanners.chrome_device_scanner import (
    ChromeDevice,
...
class TestChromeDeviceScanner:
    ...
    @patch("sentyr.core.scanners.chrome_device_scanner.ChromeDeviceScanner._list_all_devices")
    ...
    def test_generate_issues(self, chrome_scanner):
        ...
        from datetime import timezone
        from sentyr.core.scanners.chrome_device_scanner import ChromeDeviceScanResult
