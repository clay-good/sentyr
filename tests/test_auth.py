...
from sentyr.core.auth.credentials import (
    CredentialManager,
    AuthenticationError,
    create_credential_manager_from_config,
)
from sentyr.core.auth.client import GoogleWorkspaceClient, APIError
...
class TestCredentialManager:
    ...
    @patch("sentyr.core.auth.credentials.service_account")
    ...
    @patch("sentyr.core.auth.credentials.Credentials")
    @patch("os.path.exists")
    ...
    @patch("sentyr.core.auth.credentials.Credentials")
    @patch("sentyr.core.auth.credentials.Request")
    @patch("os.path.exists")
    ...
    @patch("sentyr.core.auth.credentials.InstalledAppFlow")
    @patch("sentyr.core.auth.credentials.Credentials")
    @patch("os.path.exists")
...
class TestGoogleWorkspaceClient:
    ...
    @patch("sentyr.core.auth.client.build")
    ...
    def test_create_client_from_config(self):
        ...
        with patch("os.path.exists", return_value=True):
            with patch("sentyr.core.auth.credentials.service_account"):
