...
Tests all major components of Sentyr
"""
...
print("="*80)
print("SENTYR v0.17.0 - COMPREHENSIVE SYSTEM TEST")
print("="*80)
print()
...
try:
    from sentyr.validators import validate_event
...
required_files = [
    ...
    "sentyr/cli.py",
    "sentyr/ml_engine.py",
    "sentyr/advanced_ml.py",
    "sentyr/streaming.py",
    "sentyr/forensics.py",
    "sentyr/incidents.py",
    "sentyr/ai_soc_analytics.py",
    "requirements.txt",
    "setup.py",
    "README.md",
    "Dockerfile",
