...
from sentyr.core.scanners.calendar_scanner import (
    CalendarScanner,
    CalendarInfo,
    CalendarEvent,
)
...
class TestCalendarScanner:
    ...
    def test_generate_issues_public_calendar(self, calendar_scanner):
        ...
        from sentyr.core.scanners.calendar_scanner import CalendarScanResult
    ...
    def test_scan_calendar_events_with_pii(self, calendar_scanner, mock_client):
        ...
        from sentyr.core.detectors.pii_detector import PIIMatch, PIIType
