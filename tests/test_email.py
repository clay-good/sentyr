...
from sentyr.core.scanners.file_scanner import FileInfo
...
class TestEmailAlerter:
    ...
    def test_create_body(self, email_alerter, sample_report):
        ...
        assert "Sentyr Security Scan Report" in body
    ...
    @patch("sentyr.integrations.email.smtplib.SMTP")
    ...
    @patch("sentyr.integrations.email.smtplib.SMTP_SSL")
    ...
    def test_threshold_not_met(self, email_alerter):
        ...
        with patch("sentyr.integrations.email.smtplib.SMTP") as mock_smtp:
