...
from sentyr.core.scanners.license_scanner import (
    LicenseScanner,
    LicenseAssignment,
    LicenseSKU,
    LicenseScanResult,
...
class TestLicenseScanner:
    ...
    @patch("sentyr.core.scanners.license_scanner.LicenseScanner._list_all_skus")
    @patch("sentyr.core.scanners.license_scanner.LicenseScanner._list_all_assignments")
