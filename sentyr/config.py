"""Configuration management for Sentyr."""
...
class SentyrConfig(BaseSettings):
    """Main configuration for Sentyr."""
    ...
    def validate_production_settings(self) -> 'SentyrConfig':
...
def load_config(api_key: Optional[str] = None, environment: Optional[str] = None) -> SentyrConfig:
    """
    ...
    return SentyrConfig(**kwargs)


def load_config_from_file(config_file: Path) -> SentyrConfig:
    """
    ...
    return SentyrConfig(**config_data)

# Global configuration instance
_global_config: Optional[SentyrConfig] = None


def get_config() -> SentyrConfig:
    """
    ...
    Returns:
        Global SentyrConfig instance
    """
    global _global_config
    if _global_config is None:
        try:
            _global_config = SentyrConfig()
        except Exception:
...
def set_config(config: SentyrConfig) -> None:
    """
