"""
Notification integrations for Sentyr.
...
class NotificationConfig(BaseModel):
    ...
    slack_username: Optional[str] = Field("Sentyr", description="Slack bot username")
...
class NotificationManager:
            ...
            "attachments": [
                {
                    ...
                    "footer": "Sentyr Security Analysis",
    ...
    def _send_email(
        ...
        msg['Subject'] = f"[Sentyr] Security Alert - Risk {result.risk_score}/10"
...
---
Generated by Sentyr Security Analysis Framework
"""
