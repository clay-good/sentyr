...
from sentyr.core.scanners.file_scanner import FileScanner, FileInfo
from sentyr.core.detectors.pii_detector import PIIDetector, PIIDetectionResult
from sentyr.core.utils.concurrent import ConcurrentProcessor
from sentyr.integrations.email import EmailAlerter
    ...
    def _send_alert(self, finding: FileWithPII) -> None:
        ...
        if self.email_alerter and self.config.alert_email:
            try:
                ...
                subject = f"[Sentyr] PII Detected in External File: {finding.file_info.name}"
                ...
                <body>
                    ...
                    <p style="margin-top: 30px; color: #666;">
                        This is an automated alert from Sentyr.<br>
