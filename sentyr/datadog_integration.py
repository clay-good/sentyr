"""Datadog Case Management Integration for Sentyr.
...
from sentyr.models import SecurityEvent, Severity, AnalysisResult
from sentyr.incidents import Incident, IncidentStatus
...
@dataclass
class SyncMapping:
    """Mapping between Sentyr incident and Datadog case."""
    incident_id: str
    case_id: str
    last_synced: datetime
    sync_direction: str  # "sentyr_to_datadog", "datadog_to_sentyr", "bidirectional"
...
class DatadogCaseManager:
    """Manages bidirectional synchronization between Sentyr and Datadog cases."""
    ...
    async def create_case_from_incident(
        ...
        try:
            ...
            # Build tags
            tags = [
                f"sentyr:incident:{incident.incident_id}",
            ...
            case = await self.api_client.create_case(
                ...
                tags=tags,
                attributes={
                    "sentyr_incident_id": incident.incident_id,
                    "sentyr_priority": incident.priority.value
                }
            )
    ...
    async def sync_case_to_incident(
        ...
        """Sync Datadog case updates to Sentyr incident."""
        try:
            # Map status
    ...
    def _map_severity_to_priority(self, severity: Severity) -> DatadogCasePriority:
        """Map Sentyr severity to Datadog priority."""
        mapping = {
