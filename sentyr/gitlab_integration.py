...
class GitLabIntegration:
    ...
    async def create_remediation_mr(
        ...
        # Create branch name
        branch_name = f"sentyr/fix-{vulnerability_id}"
        ...
        mr = await self.client.create_merge_request(
            ...
            title=title,
            description=description,
            labels=["security", "sentyr", "automated-fix"]
        )
...
def get_gitlab_integration(config: Optional[SentyrConfig] = None) -> GitLabIntegration:
