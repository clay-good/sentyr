"""REST API server for Sentyr SOAR integration."""
...
from sentyr.config import load_config
from sentyr.parsers import (
    GuardDutyParser,
...
from sentyr.notifications import NotificationManager, NotificationConfig
from sentyr.metrics import get_metrics_collector
from sentyr.correlation import CorrelationEngine
from sentyr.playbooks import PlaybookEngine, ActionStatus, ApprovalLevel
from sentyr.threat_feeds import ThreatFeedIntegration
from sentyr.dashboard import DashboardManager, get_dashboard_manager
from sentyr.visualizations import VisualizationEngine, get_visualization_engine
from sentyr.incidents import (
...
async def startup_event():
    ...
    try:
        ...
        logger.info("Sentyr API server started successfully")
...
async def shutdown_event():
    """Cleanup on shutdown."""
    logger.info("Shutting down Sentyr API server...")
    ...
    logger.info("Sentyr API server shutdown complete")
...
async def create_test_event():
    ...
    from sentyr.models import SecurityEvent, Severity, EventCategory
...
async def add_cep_pattern(
    ...
    try:
        ...
        from sentyr.models import Severity
...
async def create_hunt_campaign(
    ...
    try:
        from sentyr.threat_hunting import get_threat_hunting_engine, HuntType
...
async def start_hunt_campaign(hunt_id: str):
    ...
    try:
        from sentyr.threat_hunting import get_threat_hunting_engine
        engine = get_threat_hunting_engine()
...
async def list_hunt_campaigns(status: Optional[str] = None, limit: int = 100):
    ...
    try:
        from sentyr.threat_hunting import get_threat_hunting_engine, HuntStatus
        engine = get_threat_hunting_engine()
...
async def create_workflow(
    ...
    try:
        from sentyr.soar import get_soar_platform, WorkflowAction, ActionType
...
async def execute_workflow(workflow_id: str, context: Optional[Dict[str, Any]] = None):
    ...
    try:
        from sentyr.soar import get_soar_platform
        platform = get_soar_platform()
...
async def list_workflows(status: Optional[str] = None, limit: int = 100):
    """List SOAR workflows."""
    try:
        from sentyr.soar import get_soar_platform, WorkflowStatus
        platform = get_soar_platform()
...
async def create_case(
    ...
    try:
        from sentyr.soar import get_soar_platform, CasePriority
        platform = get_soar_platform()
...
async def list_cases(status: Optional[str] = None, limit: int = 100):
    """List security cases."""
    try:
        from sentyr.soar import get_soar_platform, CaseStatus
        platform = get_soar_platform()
...
async def assess_compliance_framework(framework: str, assessed_by: Optional[str] = None):
    ...
    try:
        from sentyr.compliance import get_compliance_engine, ComplianceFramework
...
async def log_audit_event(
    ...
    """Log an audit event."""
    try:
        from sentyr.compliance import get_compliance_engine
        engine = get_compliance_engine()
...
async def enrich_ioc(
    ...
    try:
        from sentyr.threat_intel_integration import get_threat_intel_integration, IOCType, ThreatIntelSource
...
async def batch_enrich_iocs(
    ...
    try:
        from sentyr.threat_intel_integration import get_threat_intel_integration, IOCType
...
async def get_mitre_technique(technique_id: str):
    ...
    try:
        from sentyr.threat_intel_integration import get_threat_intel_integration
...
async def generate_hypothesis(context: Dict[str, Any]):
    ...
    try:
        from sentyr.advanced_automation import get_advanced_automation
...
async def create_datadog_case(
    ...
    """
    Create Datadog case from Sentyr incident.

    Creates a new case in Datadog Case Management and establishes
    bidirectional sync mapping.
    """
    try:
        from sentyr.datadog_integration import get_datadog_case_manager
        from sentyr.incidents import get_incident_manager
...
async def list_datadog_cases(
    ...
    try:
        from sentyr.datadog_integration import (
...
async def sync_incident_to_case(
    ...
    """Sync Sentyr incident updates to Datadog case."""
    try:
...
async def run_datadog_tests(
    ...
    try:
        from sentyr.datadog_live_testing import run_live_tests
...
async def get_tickets_for_incident(incident_id: str):
    ...
    try:
        from sentyr.ticketing import get_unified_ticketing_manager
...
async def scan_cloud_resources(
    ...
    """
    try:
        from sentyr.cspm import get_cloud_scanner, CloudProvider
...
async def assess_compliance(
    ...
    """
    try:
        from sentyr.cspm import get_cspm_orchestrator, CloudProvider, ComplianceFramework
...
async def get_compliance_findings(
    ...
    try:
        from sentyr.cspm import get_compliance_engine, Severity, ComplianceFramework
...
async def check_configuration_drift():
    ...
    try:
        from sentyr.cspm import get_cloud_scanner, get_drift_engine
...
async def scan_vulnerabilities():
    ...
    try:
        from sentyr.cspm import get_cloud_scanner
        from sentyr.vulnerability_management import get_vulnerability_scanner
...
async def create_remediation_plan(
    ...
    try:
        from sentyr.cspm import get_cloud_scanner, get_compliance_engine
        from sentyr.remediation import get_remediation_engine
...
async def get_cspm_statistics():
    """Get CSPM statistics."""
    try:
        from sentyr.cspm import get_cspm_orchestrator
...
async def scan_container_image(
    ...
    """
    try:
        from sentyr.container_security import get_container_scanner
...
async def scan_kubernetes_namespace(
    ...
    """
    try:
        from sentyr.container_security import get_k8s_scanner
...
async def monitor_container_runtime(
    ...
    """
    try:
        from sentyr.container_security import get_runtime_monitor
...
async def generate_sbom(
    ...
    """
    try:
        from sentyr.container_security import get_supply_chain_security, get_container_scanner
...
async def full_container_security_assessment(
    ...
    """
    try:
        from sentyr.container_security import get_container_security_orchestrator
...
async def analyze_iam_principal(
    ...
    """
    try:
        from sentyr.iam_security import get_iam_analyzer, IAMPrincipal, IAMPrincipalType
        from sentyr.cspm import CloudProvider
...
async def scan_file_for_secrets(
    ...
    """
    try:
        from sentyr.iam_security import get_secrets_scanner, SecretLocation
...
async def scan_directory_for_secrets(
    ...
    """
    try:
        from sentyr.iam_security import get_secrets_scanner
...
async def register_credential(
    ...
    """
    try:
        from sentyr.iam_security import get_credential_manager
...
async def create_zero_trust_policy(
    ...
    """
    try:
        from sentyr.iam_security import get_zero_trust_engine, ZeroTrustPolicyAction
...
async def evaluate_zero_trust_access(
    ...
    """
    try:
        from sentyr.iam_security import get_zero_trust_engine
...
async def analyze_identity_threat(
    ...
    """
    try:
        from sentyr.iam_security import get_identity_threat_detector, IAMPrincipal, IAMPrincipalType
...
async def perform_full_iam_assessment(
    ...
    """
    try:
        from sentyr.iam_security import get_iam_orchestrator, IAMPrincipal, IAMPrincipalType
...
async def get_iam_security_statistics():
    ...
    try:
        from sentyr.iam_security import (
            get_iam_analyzer,
            get_secrets_scanner,
...
async def analyze_firewall_rule(
    ...
    """
    try:
        from sentyr.network_security import (
...
async def classify_data(
    ...
    """
    try:
        from sentyr.network_security import get_data_classifier
...
async def enforce_dlp_policy(
    ...
    """
    try:
        from sentyr.network_security import get_dlp_engine
...
async def rotate_encryption_key(
    ...
    """
    try:
        from sentyr.network_security import get_encryption_manager
...
async def scan_api_endpoint(
    ...
    """
    try:
        from sentyr.api_security import get_api_scanner, APIEndpoint, APIMethod, AuthType
...
async def test_sql_injection(
    ...
    """
    try:
        from sentyr.api_security import get_app_tester
...
async def analyze_api_request(
    ...
    """
    try:
        from sentyr.api_security import get_threat_protection
        import json
...
async def schedule_security_scan(
    ...
    """
    try:
        from sentyr.api_security import get_security_automation
...
async def perform_full_api_security_assessment(
    ...
    """
    try:
        from sentyr.api_security import get_api_security_orchestrator, APIEndpoint, APIMethod, AuthType
...
async def get_api_security_statistics():
    ...
    """
    try:
        from sentyr.api_security import (
            get_api_scanner,
            get_app_tester,
...
async def configure_devsecops_pipeline(
    ...
    try:
        from sentyr.devsecops import get_devsecops_pipeline, PipelineConfig, PipelineType, SecurityGateType
...
async def execute_security_gates(
    ...
    try:
        from sentyr.devsecops import get_devsecops_pipeline
...
async def create_orchestration_workflow(
    ...
    try:
        from sentyr.devsecops import get_orchestration_hub, OrchestrationWorkflow, OrchestrationAction
...
async def execute_orchestration_workflow(
    ...
    try:
        from sentyr.devsecops import get_orchestration_hub
...
async def ingest_threat_indicator(
    ...
    try:
        from sentyr.devsecops import get_threat_intelligence, ThreatIntelIndicator, ThreatIntelSource, Severity
...
async def correlate_threat_indicators(
    ...
    try:
        from sentyr.devsecops import get_threat_intelligence
...
async def collect_security_metrics():
    ...
    try:
        from sentyr.devsecops import get_metrics_dashboard
...
async def execute_penetration_test(
    ...
    try:
        from sentyr.devsecops import get_automated_pentesting, PentestType
...
async def perform_full_security_assessment(
    ...
    try:
        from sentyr.devsecops import get_devsecops_orchestrator
...
async def scan_dependencies(request: Dict[str, Any]):
    ...
    try:
        from sentyr.supply_chain_security import get_supply_chain_scanner
...
async def generate_sbom(request: Dict[str, Any]):
    ...
    try:
        from sentyr.supply_chain_security import (
            get_sbom_manager,
            Dependency,
            DependencyType,
            LicenseType,
...
async def export_sbom(sbom_id: str, format: str = "json"):
    ...
    try:
        from sentyr.supply_chain_security import get_sbom_manager
...
async def evaluate_policy(request: Dict[str, Any]):
    ...
    try:
        from sentyr.supply_chain_security import get_policy_engine
...
async def assess_risk(risk_id: str):
    ...
    try:
        from sentyr.supply_chain_security import get_risk_management
...
async def assess_control(control_id: str):
    ...
    try:
        from sentyr.supply_chain_security import get_grc_platform
...
async def get_supply_chain_statistics():
    ...
    try:
        from sentyr.supply_chain_security import get_supply_chain_grc_orchestrator
...
async def calculate_posture_score(request: Dict[str, Any]):
    ...
    try:
        from sentyr.security_posture import get_security_posture_orchestrator, PostureMetric, PostureDimension
...
async def get_posture_score(organization_id: str):
    ...
    try:
        from sentyr.security_posture import get_security_posture_orchestrator
...
async def create_baseline(request: Dict[str, Any]):
    ...
    try:
        from sentyr.security_posture import get_security_posture_orchestrator, PostureScore, PostureLevel, PostureDimension, PostureMetric
...
async def get_monitoring_alerts(
    ...
    try:
        from sentyr.cspm import Severity
...
async def analyze_trend(request: Dict[str, Any]):
    ...
    try:
        from sentyr.security_posture import get_security_posture_orchestrator, PostureDimension
...
async def compare_to_industry(request: Dict[str, Any]):
    ...
    try:
        from sentyr.security_posture import get_security_posture_orchestrator, IndustryType, PostureDimension
...
async def perform_comprehensive_analysis(request: Dict[str, Any]):
    ...
    try:
        from sentyr.security_posture import get_security_posture_orchestrator, PostureMetric, PostureDimension, IndustryType
...
async def discover_assets(request: Dict[str, Any]):
    ...
    try:
        from sentyr.attack_surface_management import get_attack_surface_discovery
...
async def ingest_data(request: Dict[str, Any]):
    ...
    try:
        from sentyr.attack_surface_management import get_security_data_lake, DataSourceType
...
async def query_data(request: Dict[str, Any]):
    ...
    try:
        from sentyr.attack_surface_management import get_security_data_lake
...
async def create_threat_model(request: Dict[str, Any]):
    """Create threat model."""
    try:
        from sentyr.attack_surface_management import get_threat_modeling_engine
...
async def track_metric(request: Dict[str, Any]):
    ...
    try:
        from sentyr.attack_surface_management import get_security_metrics_dashboard
...
async def create_simulation(request: Dict[str, Any]):
    ...
    try:
        from sentyr.attack_surface_management import get_incident_simulation_platform
...
async def perform_comprehensive_assessment(request: Dict[str, Any]):
    """Perform comprehensive security assessment."""
    try:
        from sentyr.attack_surface_management import get_asm_orchestrator
