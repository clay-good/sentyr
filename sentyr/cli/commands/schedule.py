...
from sentyr.core.scheduler import (
    ScanScheduler,
    ScheduleType,
    ScanType,
    get_scheduler,
...
def add_schedule(
    ...
    Examples:
        ...
        sentyr schedule add -n "Gmail Monitor" -t gmail --schedule-type interval -s "30m"
    """
    import json
...
def run_scheduler(daemon: bool) -> None:
    ...
    if daemon:
        ...
        console.print("  Use 'sentyr schedule stop' to stop")
    else:
