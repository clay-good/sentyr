...
from sentyr.core.lifecycle.offboarding import OffboardingManager
...
def offboard_user(
    ...
    Example:
        sentyr offboard user john@company.com --transfer-to manager@company.com
    """
    try:
        # Load config
...
def list_suspended(ctx):
    ...
    Example:
        sentyr offboard list-suspended
    """
    try:
        # Load config
        config = load_config(ctx.obj.get("config_path"))
