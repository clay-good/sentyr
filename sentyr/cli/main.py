"""Main CLI entry point for Sentyr."""
...
from sentyr import __version__
...
@click.group()
@click.version_option(version=__version__, prog_name="sentyr")
@click.option(
    "--config",
    "-c",
    type=click.Path(path_type=Path),
    envvar="SENTYR_CONFIG",
...
def cli(ctx: click.Context, config: Optional[Path], verbose: bool, debug: bool) -> None:
    """Sentyr: Google Workspace Security & Compliance Tool.
...
def version(ctx: click.Context) -> None:
    ...
    console.print(
        Panel(
            f"[bold cyan]Sentyr[/bold cyan] v{__version__}\n\n"
...
def init(ctx: click.Context, oauth: bool, force: bool) -> None:
    ...
    """
    from sentyr.cli.commands.init import init_command

    init_command(ctx, oauth, force)


# Import and register custom PII commands
from sentyr.cli.commands.custom_pii import custom_pii_group
...
def scan_files(
    ...
    from sentyr.cli.commands.scan import scan_files_command
...
def scan_users(
    ...
    from sentyr.cli.commands.scan import scan_users_command
...
def scan_shared_drives(
    ...
    from sentyr.cli.commands.scan import scan_shared_drives_command
...
def scan_oauth_apps(
    ...
    from sentyr.cli.commands.scan import scan_oauth_apps_command
...
def scan_groups(
    ...
    from sentyr.cli.commands.scan import scan_groups_command
...
def scan_gmail(
    ...
    from sentyr.cli.commands.scan import scan_gmail_command
...
def scan_gmail_security(
    ...
    from sentyr.cli.commands.scan import scan_gmail_security_command
...
def scan_audit_logs(
    ...
    from sentyr.cli.commands.scan import scan_audit_logs_command
...
def scan_calendar(
    ...
    from sentyr.cli.commands.scan import scan_calendar_command
...
def scan_vault(
    ...
    from sentyr.cli.commands.scan import scan_vault_command
...
def scan_devices(
    ...
    from sentyr.cli.commands.scan import scan_mobile_devices_command
...
def scan_chrome_devices(
    ...
    from sentyr.cli.commands.scan import scan_chrome_devices_command
...
def scan_licenses(
    ...
    from sentyr.cli.commands.scan import scan_licenses_command
...
def generate_report(
    ...
    from sentyr.cli.commands.report import generate_report_command
...
def generate_dashboard(
    ...
    from sentyr.cli.commands.report import generate_dashboard_command
...
def test(ctx: click.Context, test_email: bool) -> None:
    """Test Sentyr configuration and connectivity."""
    from sentyr.cli.commands.test import test_command
...
def config(ctx: click.Context) -> None:
    ...
    from sentyr.cli.commands.config import config_command
...
def offboard(ctx: click.Context) -> None:
    ...
    from sentyr.cli.commands.offboard import offboard as offboard_group
...
from sentyr.cli.commands.offboard import offboard as offboard_group
from sentyr.cli.commands.policy import policy as policy_group
...
def compliance(
    ...
    from sentyr.cli.commands.compliance import compliance_report_command
...
from sentyr.cli.commands.monitor import monitor_group
from sentyr.cli.commands.workflow import workflow_group
from sentyr.cli.commands.metrics import metrics
from sentyr.cli.commands.schedule import schedule
from sentyr.cli.commands.users import users_group
from sentyr.cli.commands.bulk import bulk_group
from sentyr.cli.commands.ou import ou_group
from sentyr.cli.commands.backup import backup_group
from sentyr.cli.commands.resources import resources_group
