"""
Automated Remediation Engine for Sentyr.
...
from sentyr.cspm import CloudResource, Finding, CloudProvider, ResourceType
from sentyr.vulnerability_management import VulnerabilityAssessment, CVEDetails
