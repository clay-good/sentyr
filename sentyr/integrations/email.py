...
class EmailAlerter:
    ...
    def send_test_email(self, recipients: List[str]) -> None:
        ...
        msg["From"] = self.from_address
        msg["To"] = ", ".join(recipients)
        msg["Subject"] = "Sentyr Test Email"

        body = """
        <html>
        <body>
            <h2>Sentyr Test Email</h2>
            <p>This is a test email from Sentyr.</p>
    ...
    def _create_subject(self, report: ScanReport) -> str:
        ...
        return f"[Sentyr] {severity} - {report.files_with_issues} Files with Issues"
    ...
    def _create_body(self, report: ScanReport) -> str:
        ...
        <body>
            <h2>Sentyr Security Scan Report</h2>
