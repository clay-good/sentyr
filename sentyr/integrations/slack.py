...
class SlackAlerter:
    ...
    def send_test_message(self) -> None:
        ...
        message = {
            ...
            "text": "🧪 Sentyr Test Alert",
            "attachments": [
                {
                    "color": "good",
                    "text": "This is a test message from Sentyr. Your Slack integration is working correctly!",
                    "footer": "Sentyr",
    ...
    def _build_message(self, report: ScanReport) -> Dict[str, Any]:
        ...
        # Build main text
        text = f"{severity} - Sentyr Security Scan"
...
def create_slack_alerter_from_config(config: Dict[str, Any]) -> Optional[SlackAlerter]:
    ...
    return SlackAlerter(
        ...
        username=slack_config.get("username", "Sentyr"),
