...
from sentyr.incidents import Incident, IncidentStatus, IncidentPriority, Severity
...
@dataclass
class SyncMapping:
    """Mapping between Sentyr incident and ServiceNow incident."""
    incident_id: str
    snow_sys_id: str
    snow_number: str
    last_synced: datetime
    sync_direction: str  # "sentyr_to_snow", "snow_to_sentyr", "bidirectional"
...
class ServiceNowIncidentManager:
    ...
    def _map_severity_to_priority(self, severity: Severity) -> ServiceNowPriority:
        """Map Sentyr severity to ServiceNow priority."""
        mapping = {
    ...
    def _map_severity_to_impact(self, severity: Severity) -> ServiceNowImpact:
        """Map Sentyr severity to ServiceNow impact."""
    ...
    def _map_severity_to_urgency(self, severity: Severity) -> ServiceNowUrgency:
        """Map Sentyr severity to ServiceNow urgency."""
        if severity in [Severity.CRITICAL, Severity.HIGH]:
    ...
    def _build_incident_description(
        ...
        """Build ServiceNow incident description from Sentyr incident."""
        lines = [
            f"Sentyr Incident ID: {incident.incident_id}",
    ...
    async def create_incident_from_sentyr(
        self,
        incident: Incident,
        analysis: Optional[AnalysisResult] = None
    ) -> Optional[ServiceNowIncident]:
        """Create ServiceNow incident from Sentyr incident."""
        try:
            ...
            if snow_incident:
                ...
                mapping = SyncMapping(
                    ...
                    metadata={
                        ...
                        "sentyr_severity": incident.severity.value,
                ...
                logger.info(f"Created ServiceNow incident {snow_incident.number} for Sentyr incident {incident.incident_id}")
    ...
    async def sync_incident_to_servicenow(
        ...
        """Sync Sentyr incident updates to ServiceNow."""
        try:
            # Map status
            state_mapping = {
            ...
            if snow_incident:
                ...
                logger.info(f"Synced Sentyr incident {incident.incident_id} to ServiceNow {snow_incident.number}")
