#!/usr/bin/env python3
"""
Example client for Sentyr REST API.

This script demonstrates how to interact with the Sentyr API
...
def main():
    ...
    try:
        ...
        print("  python -m sentyr.cli serve")
        sys.exit(1)
